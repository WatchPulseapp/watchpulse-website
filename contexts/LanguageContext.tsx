...
const translations = {
  tr: {
    ...
    social: {
      ...
      posts: {
        ...
        desc: 'Her gönderi bir yapıma bağlıdır. Beş tür var: tartışma, eleştiri, öneri, soru ve süreli anket. Spoiler etiketlediğin içerik, karşı taraf dokunana kadar kapalı kalır.',
      },
      follow: {
        title: 'Takip Sistemi',
    ...
    // Labels for the three mock-ups. Kept apart from the feature copy above
    // because these are captions on a picture of the app, not claims about it.
    socialDemo: {
      matchLabel: 'Eşleşme önerisi',
      postLabel: 'Akış',
      chatLabel: 'Sohbet',
      matchName: 'elifk',
      matchTier: 'RUH İKİZİ',
      matchMutual: 'İkiniz de @burak, @deniz takip ediyorsunuz',
      matchInsight: '5 ortak içerik · 3 ortak tür',
      sharedLabel: 'Ortak içerik',
      g1: 'Dram',
      g2: 'Gizem',
      g3: 'Bilim Kurgu',
      post1User: 'burakd',
      ...
      post1Type: 'Eleştiri',
      post1Body:
        'Son on dakikadaki davul sahnesi tek başına filmi taşıyor. Öncesindeki bütün gerilim orada patlıyor.',
      post2User: 'denizy',
      post2Time: '5sa',
      post2Type: 'Anket',
      post2Body: 'Dark ilk sezondan sonra kafa karıştırıyor mu, yoksa asıl orada mı açılıyor?',
      opt1: 'Asıl orada açılıyor',
      opt2: 'Kafam karıştı',
      pollMeta: '412 oy · 6 saat kaldı',
    },
    grid: {
      title: 'DAHA BİTMEDİ',
  ...
  en: {
    ...
    socialDemo: {
      matchLabel: 'Match suggestion',
      postLabel: 'The feed',
      chatLabel: 'Chat',
      matchName: 'elifk',
      matchTier: 'SOUL TWIN',
      matchMutual: 'You both follow @burak, @deniz',
      matchInsight: '5 shared titles · 3 shared genres',
      sharedLabel: 'Shared',
      g1: 'Drama',
      g2: 'Mystery',
      g3: 'Sci-Fi',
      ...
      post1Type: 'Review',
      post1Body:
        'The drum solo in the last ten minutes carries the whole film on its own. Everything held back until then lands at once.',
      post2User: 'denizy',
      post2Time: '5h',
      post2Type: 'Poll',
      post2Body: 'Does Dark lose you after season one, or is that where it finally opens up?',
      opt1: 'That is where it opens up',
      opt2: 'Lost me completely',
      pollMeta: '412 votes · 6 hours left',
    },
    grid: {
      title: "THERE'S MORE",
